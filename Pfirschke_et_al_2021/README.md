...
| Initial visualization of the data using SPRING [5]| [Interactive explorer online](https://kleintools.hms.harvard.edu/tools/springViewer_1_6_dev.html?datasets/pittet/mouse/CSF1Ri/all_cells_w_dblt_1000umi) | 2B visualization using a force directed layout of a kNN graph | [part3c_spring_plot_1000_umi.ipynb](methods_clean_visual_annot/part3c_spring_plot_1000_umi.ipynb) | RZ
...
| State %CD45 abundance, Arrow gene-expression change, and Differential Expression Analysis volcano Figures | 2E, 2F, S2A, S2C, S2D, S2F, S2G, 4G, S4H, S4J, S4K, 5F, S5D-I | |  [Abundance_and_expression_change_analysis.ipynb](methods_post_annotation/Abundance_and_expression_change_analysis.ipynb) | MM |
