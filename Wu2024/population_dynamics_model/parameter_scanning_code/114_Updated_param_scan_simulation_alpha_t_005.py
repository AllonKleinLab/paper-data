...
output_filename = f'simulation_results_114/simulation_tracker_df_005_{args.sim_num}.csv'
...
'del_g':[0.25,1.5],
'K_r21' : [1e-2,100], ## The ratio for which Epo surval over amplificaiton
        ...
        for i in range(len(param_samples['K_r21'])):
            ...
            parameter_sets = {
                'normoxia_il17': {
                    ...
                    'custom_K_r21': param_values['K_r21'],
